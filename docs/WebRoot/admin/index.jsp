				...
				<div class="sBox">
					...
					<ul class="navContent" style="display: block">
						...
						<li>
							...
							<a href="/admin/bugList.jsp" target="content"><span
								class="sublist-icon glyphicon glyphicon-credit-card"></span><span
						...
						<li>
							...
							</div> <a href="/admin/articleList.jsp" target="content"><span
								class="sublist-icon glyphicon glyphicon-credit-card"></span><span
				...
				<div class="sBox">
					...
					<ul class="navContent" style="display: none">
						<li>
							...
							</div> <a href="/admin/userList.jsp" target="content"><span
								class="sublist-icon glyphicon glyphicon-user"></span><span
								class="sub-title">人员管理</span></a>
						</li>
						<li>
							<div class="showtitle" style="width: 100px;">
								<img src="../img/leftimg.png" />分类管理
							</div> <a href="/admin/categoryList.jsp" target="content"><span
								class="sublist-icon glyphicon glyphicon-user"></span><span
								class="sub-title">分类管理</span></a>
						</li>
						<li>
							<div class="showtitle" style="width: 100px;">
								<img src="../img/leftimg.png" />排班情况
							</div> <a href="/admin/arrange.jsp" target="content"><span
								class="sublist-icon glyphicon glyphicon-user"></span><span
